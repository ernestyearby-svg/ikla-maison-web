...
export const BRANDS = {
  ...
  'my-drink-family': {
    ...
    assets: {
      heroDesktop: 'assets/my-drink-family/hero-editorial-merch.webp',
      heroMobile: 'assets/my-drink-family/hero-editorial-merch-mobile.webp',
      collection: 'assets/my-drink-family/collection.webp',
      editorial: 'assets/my-drink-family/editorial.webp',
    },
    alt: {
      heroDesktop: 'Sophisticated adult models wearing sports-luxury coordinated loungewear on a twilight resort terrace with champagne gold ice chiller and crystal flutes',
      heroMobile: 'Adult models wearing sports-luxury coordinated loungewear on a twilight resort terrace with crystal flutes',
