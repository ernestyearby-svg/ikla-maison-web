...
export const HERO_HOUSES = [
  {
    ...
    cta: 'Explore IKLA',
    image: 'assets/campaigns/round-four/ikla-mens-editorial-lifestyle.webp',
    alt: 'IKLA Maison refined tailoring and luxury essentials in travertine atrium',
  ...
  },
  {
    ...
    alt: 'KTSE brutalist heavyweight streetwear in metropolitan concrete plaza',
  ...
  },
  {
    ...
    alt: 'Moral Compass executive tailoring and cardinal overcoats overlooking city skyline',
  ...
  },
  {
    ...
    alt: 'WNNR athletes wearing Obsidian and Bone uniforms at sunrise',
  ...
  },
  {
    ...
    image: 'assets/campaigns/01-ready-to-use/ikla-water/ikla-water-dining-table.jpg',
    alt: 'IKLA Water sculptural flint glass decanter in formal dining setting',
